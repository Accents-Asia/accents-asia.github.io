...
articles:
    - title: "Newspaper Subjectivity from Multimodal Perspectives"
      author: Makoto Sakai, University of Birmingham, U.K.
      url: http://www.issues.accentsasia.org/issues/4-1/sakai.pdf
    ...
    - title: "Language Attrition of Japanese Returnee Students"
      author: Gota Hayashi, Kanda University of International Studies, Japan
      url: http://www.issues.accentsasia.org/issues/4-1/hayashi.pdf
      abstract: "The question posed for this paper is regarding Japanese returnee students, since according to Hansen, the documentation on Japanese returnees’ loss of ESL is still　fragmentary (Hansen & Kurashige, 1999). This paper analyzes six primary articles that examine current attrition research of Japanese returnees in order to formulate pedagogical implications."
    
    - title: "Aspects of Phonological Competence in Japanese EFL Learners"
      author: Shawn Beasom
      url: http://www.issues.accentsasia.org/issues/4-1/beasom.pdf
      abstract: "This study evaluates practical phonological competence in Japanese native speakers (JNS) at the first and second year college level in terms of production and recognition of second language (L2) phones. Methodology in the first part of the study involves 100 JNS listeners attempting to differentiate and identify L2 phones produced by an English native speaker (ENS) in 1 and 2 syllable words. In the second part of the study, the same words are produced on videotape by a group of 5 JNS readers for 2 ENS groups: 23 residents of Japan and 31 U.S. residents. Results from this learner group indicate a consistent pattern of significant deficiencies in the ability to produce and recognize L2 phones."
    
    - title: "Oral Proficiency Interviews and Student Motivation"
      author: Guy Smith, Tokyo Woman’s Christian University, Japan
      url: http://www.issues.accentsasia.org/issues/4-1/smith.pdf
